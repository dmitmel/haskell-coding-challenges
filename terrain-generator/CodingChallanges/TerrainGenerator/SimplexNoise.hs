...
Module for generating <https://en.wikipedia.org/wiki/Simplex_noise Simplex noise>.

Taken from https://github.com/weswigham/simplex/blob/master/haskell/simplex.hs.
-}

module CodingChallanges.TerrainGenerator.SimplexNoise (noise2D) where
